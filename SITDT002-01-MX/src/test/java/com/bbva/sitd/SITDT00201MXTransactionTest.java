...
/**
 * Test for transaction SITDT00201MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/SITDT00201MXTest.xml" })
public class SITDT00201MXTransactionTest {

	@Autowired
	private SITDT00201MXTransaction transaction;
	...
	public void testNotNull(){
		...
		addParameter("tipoContenido",entretenimiento);
		
		PaginationInDTO paginationIn = new PaginationInDTO();
		addParameter("paginationIn",entretenimiento);
